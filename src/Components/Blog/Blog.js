                  ...
                  <div>
                    ...
                    <div class="px-4 py-2">
                      ...
                      <p class="text-sm tracking-normal">
                        ...
                        dishes that we can't imagine our lives without! Take,
                        for instance, chilli paneer - an Indo-Chinese dish that
                        is a delicious combination of Indian and Chinese
                        cuisines. But it is our culinary genius and expertise
                        that led to the invention of chilli paneer! While some
              ...
              <div>
                <div class="shadow-lg hover:shadow-xl transform transition duration-500 hover:scale-105">
                  <div>
                    ...
                    <div class="px-4 py-2">
                      <h1 class="text-lg font-gray-700 font-bold">
                        Chicken Wings Recipe: Make These Tantalising Chicken
                        Wings A Desi Twist
                      </h1>
                      <div class="flex space-x-2 mt-2"></div>
                      <p class="text-sm tracking-normal">
                        There is no denying that chicken makes for one of the
                        most satisfying meals. Deep fry them for those
                        restaurant-style fried chicken wings or roast them on
                        the tandoor for that authentic desi favorite Tandoori
                        chicken. No matter which recipe you choose, the dish is
                ...
                <div class="shadow-lg hover:shadow-xl transform transition duration-500 hover:scale-105">
                  <div>
                    ...
                    <div class="px-4 py-2">
                      ...
                      <div class="flex space-x-2 mt-2"></div>
                      <p class="text-sm tracking-normal">
                        Fried Chicken Recipes: Find out the best of fried
                        chicken recipes to prepare at home, complete with key
                        ingredients and a step by step process. From stir fried
                        chilli chicken to oat crusted chicken tenders and the
                        classic fried chicken wings, we've got it all.Let's just
                        agree already that chicken meals are the way to a
