                ...
                <div className="container">
                    <div className="row mt-5">
                        ...
                        <div>
                            ...
                            <p>
                            এই কুকি নীতি ব্যাখ্যা করে কিভাবে আমরা আমাদের ওয়েবসাইটে [www.fryfrenzy.com] কুকিজ এবং অনুরূপ প্রযুক্তি ব্যবহার করি। এই নীতিটি আমরা যে ধরনের কুকি ব্যবহার করি, যে উদ্দেশ্যে আমরা সেগুলি ব্যবহার করি এবং আপনি কীভাবে আপনার কুকি পছন্দগুলি পরিচালনা করতে পারেন সে সম্পর্কে আপনাকে অবহিত করার উদ্দেশ্যে করা হয়েছে৷
                            </p>
                        ...
                        <div className="mt-6 flex flex-col gap-3">
                            ...
                            <p>ক. প্রয়োজনীয় কুকিজ: এই কুকিগুলি আমাদের ওয়েবসাইটের কার্যকারিতার জন্য প্রয়োজনীয় এবং আপনাকে এর বৈশিষ্ট্যগুলি নেভিগেট করতে এবং ব্যবহার করতে সক্ষম করে। এগুলি সাধারণত আপনার ক্রিয়াকলাপের প্রতিক্রিয়া হিসাবে সেট করা হয়, যেমন ওয়েবসাইটের নিরাপদ অঞ্চলগুলি অ্যাক্সেস করা বা ফর্মগুলি পূরণ করা৷ এই কুকিজ ছাড়া, আমাদের ওয়েবসাইটের কিছু অংশ সঠিকভাবে কাজ নাও করতে পারে।</p>
                            <p>খ. পারফরম্যান্স এবং অ্যানালিটিক্স কুকিজ: এই কুকিগুলি ভিজিটররা কীভাবে আমাদের ওয়েবসাইট ব্যবহার করে সে সম্পর্কে তথ্য সংগ্রহ করে, যেমন কোন পৃষ্ঠাগুলি প্রায়শই পরিদর্শন করা হয় বা যদি তারা ত্রুটি বার্তা পায়। আমরা আমাদের ওয়েবসাইটের কার্যকারিতা এবং কার্যকারিতা উন্নত করতে এবং দর্শকরা কীভাবে এটির সাথে ইন্টারঅ্যাক্ট করে তা বোঝার জন্য আমরা এই ডেটা ব্যবহার করি। এই কুকি ব্যক্তিগতভাবে শনাক্তযোগ্য তথ্য সংগ্রহ করে না।</p>
                            <p>গ. কার্যকারিতা কুকিজ: এই কুকিগুলি আমাদের ওয়েবসাইটকে আপনার করা পছন্দগুলি মনে রাখার অনুমতি দেয় (যেমন আপনার ভাষা পছন্দ বা আপনি যে অঞ্চলে আছেন) এবং উন্নত বৈশিষ্ট্যগুলি সরবরাহ করে৷ এগুলি আপনার অনুরোধ করা পরিষেবাগুলি প্রদান করতেও ব্যবহার করা যেতে পারে, যেমন আপনার লগইন বিবরণ বা পছন্দগুলি মনে রাখা।</p>
                            <p>ঘ.বিজ্ঞাপন কুকিজ: আমরা আপনার আগ্রহ এবং অনলাইন কার্যকলাপের উপর ভিত্তি করে ব্যক্তিগতকৃত বিজ্ঞাপন প্রদান করতে বিজ্ঞাপন কুকি ব্যবহার করতে পারি। এই কুকিগুলি বিভিন্ন ওয়েবসাইট জুড়ে আপনার ব্রাউজিং অভ্যাস ট্র্যাক করে এবং আপনার আগ্রহের প্রোফাইল তৈরি করতে ব্যবহার করা যেতে পারে। আপনি কতবার বিজ্ঞাপন দেখেন এবং বিজ্ঞাপন প্রচারের কার্যকারিতা পরিমাপ করতেও এগুলি ব্যবহার করা হয়।</p>
                        ...
                        <div className="mt-5">
                            ...
                            <p>
                            আমাদের কুকিজ বা এই কুকি নীতির ব্যবহার সম্পর্কে আপনার কোন প্রশ্ন বা উদ্বেগ থাকলে, অনুগ্রহ করে আমাদের সাথে [eat@fryfrenzy.com] এ যোগাযোগ করুন।
                            </p>
                        </div>
                    </div>
                    <br />
